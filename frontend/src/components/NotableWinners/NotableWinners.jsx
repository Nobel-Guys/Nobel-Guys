      ...
      <div>
        ...
        <div className="notable-winners-container">
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Malala</h2>
          <p>
          ...
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Leonid Hurwicz</h2>
          <p>
            Malala Yousafzai is the youngest Nobel laureate ever, awarded the
            Nobel Peace Prize in 2014 at the age of 17.
          </p>
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Marie Curie</h2>
          <p>
          ...
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">John Bardeen</h2>
          <p>
            John Bardeen is the only person to have won the Nobel Prize in
            Physics twice, in 1956 and 1972.
          </p>
          <img
            className="notable-winner-picture"
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Albert Einstein</h2>
          <p>
            Albert Einstein, widely regarded as one of the greatest physicists
            of all time, was never awarded the Nobel Prize for his theory of
            relativity.
          </p>
          ...
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">William Faulkner</h2>
          <p>
          ...
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Mother Teresa</h2>
          <p>
          ...
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Richard Feynman</h2>
          <p>
            Richard Feynman, who won the Nobel Prize in Physics in 1965, was
            also an accomplished bongo player.
          </p>
          ...
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Ernest Hemingway</h2>
          <p>
          ...
          <img
            ...
            width="45%"
          />
          <h2 className="notable-winners-subltitle">Linus Pauling</h2>
          <p>
